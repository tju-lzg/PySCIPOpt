...
#define BRANCHRULE_NAME          "fullstrong-forced"
#define BRANCHRULE_DESC          "full strong branching (forced branching)"
...
{  /*lint --e{715}*/
   ...
   SCIP_CALL( SCIPincludeBranchruleFullstrongForced(scip) );
 ...
 */
SCIP_RETCODE SCIPselectVarStrongBranchingForced(
   ...
   for( i = 0, c = *start; i < nlpcands && (!bothgains || i < ncomplete); ++i, ++c )
   {
      ...
      else
      {
         ...
         if( downinf || upinf )
         {
            ...
            *bestupvalid = upvalid;
            *bestscore = SCIPgetBranchScore(scip, lpcands[c], downgain, upgain);;
            break;
         }
...
{  /*lint --e{715}*/
   ...
   *result = SCIP_DIDNOTRUN;
   ...
   SCIP_CALL( SCIPselectVarStrongBranchingForced(scip, lpcands, lpcandssol, lpcandsfrac, branchruledata->skipdown,
   ...
   )
{
   ...
   SCIP_CALL( SCIPaddLongintParam(scip,
         "branching/fullstrong-forced/reevalage",
   ...
   SCIP_CALL( SCIPaddIntParam(scip,
         "branching/fullstrong-forced/maxproprounds",
   ...
   SCIP_CALL( SCIPaddBoolParam(scip,
         "branching/fullstrong-forced/probingbounds",
   ...
   SCIP_CALL( SCIPaddBoolParam(scip,
         "branching/fullstrong-forced/forcestrongbranch",
