...
cdef extern from "scip/scip.h":
    ...
    int SCIPgetNPoolCuts(SCIP* scip)  # todo verify
...
cdef extern from "scip/sepastore.h":
    ...
    int SCIPgetSelectedCutsNames(SCIP* scip, char*** cutnames)
    int SCIPsepastoreRemoveDupCuts(SCIP* scip)
    SCIP_RETCODE SCIPsepastoreDelCut(SCIP* scip, int i)
    int SCIPsepastoreRemoveInfiniteRhsCuts(SCIP* scip);
